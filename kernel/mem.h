...
#define PA2PGINFO(x)	((struct PageInfo *)(k_pageinfo + ((u64)(x) >> 12)))
#define KA2PGINFO(x)	((struct PageInfo *)(k_pageinfo + (((u64)(x) & MASK(47)) >> 12)))
...
struct PageInfo *alloc_page(u64 flags);
void init_gdt(void);
