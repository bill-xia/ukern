/**
 * Parsing ELF64 headers in 32-bit mode.
 * assumes value in 64-bit fields are under 2^32: otherwise
 * cannot be loaded/processed in 32-bit.
 */

struct uint64_m32{
    unsigned low, high;
};
typedef struct uint64_m32 Elf64_Addr;
typedef unsigned short Elf64_Half;
typedef struct uint64_m32 Elf64_Off;
typedef int Elf64_Sword;
typedef unsigned Elf64_Word;
typedef long Elf64_Slword;
typedef struct uint64_m32 Elf64_Lword;
